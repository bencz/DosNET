...
.DATA
    ...
    ; String Literals
    __str_0 DD 8
    __str_0_data DB 'Numbers:', 0
    __str_1 DD 5
    __str_1_data DB 'Alice', 0
    __str_2 DD 3
    __str_2_data DB 'Bob', 0
    __str_3 DD 7
    __str_3_data DB 'Charlie', 0
    __str_4 DD 6
    __str_4_data DB 'Names:', 0
...
__metadata_types:
    ...
    DD 4 ; MethodCount
    DD 12  ; InstanceSize
    DD OFFSET __vtbl_SimpleList`1 ; VTableOffset
...
__metadata_methods:
    ...
    DW 0 ; ParamCount
    DW 0     ; LocalCount
    DD OFFSET __SimpleList`1__ctor ; CodeOffset
    DW 65535 ; VTableSlot
    DW 8    ; StackSize
    ; Method: SimpleList`1.get_Count
    DD 43         ; NameOffset
    DD 517 ; Flags
    DD 2 ; DeclaringTypeIndex
    DD 0                    ; SignatureOffset
    DW 0 ; ParamCount
    DW 0     ; LocalCount
    DD OFFSET __SimpleList`1_get_Count ; CodeOffset
    DW 65535 ; VTableSlot
    DW 8    ; StackSize
    ; Method: SimpleList`1.Add
    DD 53         ; NameOffset
    DD 5 ; Flags
    DD 2 ; DeclaringTypeIndex
    DD 0                    ; SignatureOffset
    DW 1 ; ParamCount
    DW 3     ; LocalCount
    DD OFFSET __SimpleList`1_Add_T0 ; CodeOffset
    DW 65535 ; VTableSlot
    DW 4    ; StackSize
    ; Method: SimpleList`1.Get
    DD 57         ; NameOffset
    DD 5 ; Flags
    DD 2 ; DeclaringTypeIndex
    DD 0                    ; SignatureOffset
    DW 1 ; ParamCount
    DW 2     ; LocalCount
    DD OFFSET __SimpleList`1_Get_Int32 ; CodeOffset
    DW 65535 ; VTableSlot
    DW 2    ; StackSize
...
IL_0000:
    NOP
    ; newobj SimpleList_Int32::.ctor
    MOV EAX, 0
    MOV EBX, 73
    CALL __gc_alloc_typed
    TEST EAX, EAX
    JZ __throw_out_of_memory
    MOV DWORD PTR [EAX], OFFSET __vtbl_SimpleList`1_System_Int32
    PUSH EAX
    CALL __SimpleList`1_System_Int32__ctor
    ADD ESP, 4
    POP EAX
    MOV [EBP-12], EAX
    PUSH DWORD PTR [EBP-12]
    PUSH 10
    CALL __SimpleList`1_System_Int32_Add_Int32
    ADD ESP, 12
    NOP
    PUSH DWORD PTR [EBP-12]
    PUSH 20
...
IL_0031:
    ...
    CALL __SimpleList`1_System_Int32_Get_Int32
    ADD ESP, 12
    PUSH EAX
...
IL_0044:
    PUSH DWORD PTR [EBP-20]
    PUSH DWORD PTR [EBP-12]
    CALL __SimpleList`1_System_Int32_get_Count
    ADD ESP, 8
    PUSH EAX
    POP EBX
    POP EAX
    ...
    JNZ IL_0031
IL_0051:
    ; newobj SimpleList_String::.ctor
    MOV EAX, 0
    MOV EBX, 74
    CALL __gc_alloc_typed
    TEST EAX, EAX
    JZ __throw_out_of_memory
    MOV DWORD PTR [EAX], OFFSET __vtbl_SimpleList`1_System_String
    PUSH EAX
    CALL __SimpleList`1_System_String__ctor
    ADD ESP, 4
    POP EAX
    MOV [EBP-16], EAX
    PUSH DWORD PTR [EBP-16]
    PUSH OFFSET __str_1
    CALL __SimpleList`1_System_String_Add_String
    ADD ESP, 12
    NOP
    PUSH DWORD PTR [EBP-16]
    PUSH OFFSET __str_2
...
IL_008B:
    ...
    CALL __SimpleList`1_System_String_Get_Int32
    ADD ESP, 12
    PUSH EAX
    CALL __System_Console_WriteLine_String
    ADD ESP, 4
...
IL_00A1:
    PUSH DWORD PTR [EBP-28]
    PUSH DWORD PTR [EBP-16]
    CALL __SimpleList`1_System_String_get_Count
    ADD ESP, 8
    PUSH EAX
    POP EBX
    POP EAX
...
; Void SimpleList`1..ctor()
PUBLIC __SimpleList`1__ctor
__SimpleList`1__ctor PROC
    PUSH EBP
    MOV EBP, ESP
    PUSH EBX
    PUSH ESI
...
IL_0000:
    ...
    POP EBP
    RET
__SimpleList`1__ctor ENDP

; Int32 SimpleList`1.get_Count()
PUBLIC __SimpleList`1_get_Count
__SimpleList`1_get_Count PROC
    PUSH EBP
    MOV EBP, ESP
    PUSH EBX
    PUSH ESI
...
IL_0000:
    ...
    POP EBP
    RET
__SimpleList`1_get_Count ENDP

; Void SimpleList`1.Add(T0)
PUBLIC __SimpleList`1_Add_T0
__SimpleList`1_Add_T0 PROC
    PUSH EBP
    MOV EBP, ESP
    SUB ESP, 12
    PUSH EBX
...
IL_0018:
    ...
    POP ESI
    PUSH DWORD PTR [ESI+8]
    CALL __System_Array_Copy_Array_Array_Int32
    ADD ESP, 8
    NOP
    PUSH DWORD PTR [EBP+8]
    PUSH DWORD PTR [EBP-16]
...
IL_0044:
    ...
    POP EBP
    RET
__SimpleList`1_Add_T0 ENDP

; T0 SimpleList`1.Get(Int32)
PUBLIC __SimpleList`1_Get_Int32
__SimpleList`1_Get_Int32 PROC
    PUSH EBP
    MOV EBP, ESP
    SUB ESP, 8
    PUSH EBX
