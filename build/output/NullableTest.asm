...
.DATA
    ...
    ; String Literals
    __str_0 DD 13
    __str_0_data DB 'Nullable Test', 0
    __str_1 DD 12
    __str_1_data DB 'a has value:', 0
    __str_2 DD 9
    __str_2_data DB 'b is null', 0
    __str_3 DD 14
    __str_3_data DB 'Default value:', 0
    __str_4 DD 15
    __str_4_data DB 'Point has value', 0
    __str_5 DD 13
    __str_5_data DB 'Point is null', 0
...
__metadata_types:
    ...
    DD 1 ; MethodCount
    DD 12  ; InstanceSize
    DD OFFSET __vtbl_Point ; VTableOffset
...
__metadata_methods:
    ...
    DW 2 ; ParamCount
    DW 0     ; LocalCount
    DD OFFSET __Point__ctor_Int32_Int32 ; CodeOffset
    DW 65535 ; VTableSlot
    DW 8    ; StackSize
...
IL_0000:
    ...
    NOP
    PUSH 42
    CALL __System_Nullable`1_System_Int32__ctor_Int32
    ADD ESP, 8
    NOP
    NOP
    NOP
    CALL __System_Nullable`1_System_Int32_get_HasValue
    ADD ESP, 4
    PUSH EAX
    POP EAX
    MOV [EBP-32], EAX
...
IL_002A:
    ...
    NOP
    NOP
    CALL __System_Nullable`1_System_Int32_get_Value
    ADD ESP, 4
    PUSH EAX
...
IL_0061:
    NOP
    PUSH 100
    CALL __System_Nullable`1_System_Int32_GetValueOrDefault_Int32
    ADD ESP, 8
    PUSH EAX
    POP EAX
    MOV [EBP-20], EAX
    ...
    MOV DWORD PTR [EAX], OFFSET __vtbl_Point
    PUSH EAX
    CALL __Point__ctor_Int32_Int32
    ADD ESP, 12
    CALL __System_Nullable`1_Point__ctor_Point
    ADD ESP, 8
    NOP
    NOP
    NOP
    CALL __System_Nullable`1_Point_get_HasValue
    ADD ESP, 4
    PUSH EAX
    POP EAX
    MOV [EBP-40], EAX
...
; Void Point..ctor(Int32, Int32)
PUBLIC __Point__ctor_Int32_Int32
__Point__ctor_Int32_Int32 PROC
    PUSH EBP
    MOV EBP, ESP
    PUSH EBX
    PUSH ESI
...
IL_0000:
    ...
    POP EBP
    RET
__Point__ctor_Int32_Int32 ENDP
