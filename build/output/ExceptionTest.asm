...
.DATA
    ...
    ; String Literals
    __str_0 DD 14
    __str_0_data DB 'Exception Test', 0
    __str_1 DD 12
    __str_1_data DB 'Before throw', 0
    __str_2 DD 30
    __str_2_data DB 'After throw (should not print)', 0
    __str_3 DD 17
    __str_3_data DB 'Caught exception:', 0
    __str_4 DD 12
    __str_4_data DB 'In try block', 0
    __str_5 DD 16
    __str_5_data DB 'Finally executed', 0
    __str_6 DD 22
    __str_6_data DB 'Test exception message', 0
...
__metadata_methods:
    ...
    DW 0 ; ParamCount
    DW 0     ; LocalCount
    DD OFFSET __Program_ThrowException ; CodeOffset
    DW 65535 ; VTableSlot
    DW 8    ; StackSize
    ; Method: Program..ctor
    DD 39         ; NameOffset
